        ...
        <div class="invoice-preview">
            <div class="invoice-header">
                <div class="invoice-header-left">
                    ...
                    <p style="font-size:11px;">info@CleanSpark.co.tz</p>
                </div>
...
function generateProfessionalReport() {
    ...
    reportHTML += `
            <div class="report-footer">
                <p>This report was generated by CleanSpark Admin Panel on ${generatedReportData.generatedAt}</p>
...
function downloadGeneratedReport() {
    ...
    a.href = url;
    a.download = `CleanSpark_Report_${generatedReportData.type}_${new Date().toISOString().slice(0, 10)}.json`;
    a.click();
...
function generateReport() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = `CleanSpark_quick_export_${reportType}_${fromDate}.json`;
    a.click();
    URL.revokeObjectURL(url);
